...
# In this example, Alice uses n=7.
...
with tempfile.TemporaryDirectory() as certificate_dir:
    ursula_seed_node = SeednodeMetadata(checksum_address="0xD5c691d5277A0dBD631c79D91024dcB9d6C5890d",
